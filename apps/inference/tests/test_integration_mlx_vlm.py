...
"supported" only because this runs green — skipped by default; skips clean when prereqs absent::
    ...
    THEYGENT_MLX_VLM_MODEL=mlx-community/Qwen2.5-VL-3B-Instruct-4bit \
        uv run --package theygent-inference pytest -m integration \
        apps/inference/tests/test_integration_mlx_vlm.py
...
from theygent_inference.launcher import MlxVlmLauncher
