...
def _state_dir() -> Path:
    ...
    ``THEYGENT_INFERENCE_STATE_DIR`` overrides the default (``~/.theygent/inference``)."""
...
def _model_dir() -> Path:
    ...
    ``THEYGENT_INFERENCE_MODEL_DIR`` overrides it (e.g. a large external volume)."""
    base = os.environ.get("THEYGENT_INFERENCE_MODEL_DIR")
